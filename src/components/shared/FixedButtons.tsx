...
export const FixedButtons = () => {
    ...
    return (
        <>
            <a href={data?.whatsapp} target="_blank" className="fixed bottom-20 right-[8%] bg-[#52C95B] w-[50px] h-[50px] flex items-center justify-center rounded-full z-2 max-[1320px]:right-5">
