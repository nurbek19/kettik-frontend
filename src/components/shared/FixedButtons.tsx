...
export const FixedButtons = () => {
    ...
    return (
        <>
            <a href="#" className="fixed bg-[#52C95B] bottom-20 right-[8%] w-[50px] h-[50px] rounded-full flex items-center justify-center max-[1320px]:right-5">
            ...
            {showButton ? (
                <div
                    onClick={scrollToTop}
                    className="button-gradient fixed bottom-5 right-[8%] w-[50px] h-[50px] flex items-center justify-center max-[1320px]:right-5"
                >
