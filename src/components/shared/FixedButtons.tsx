        ...
        <>
            <a href={data?.whatsapp} target="_blank" className="fixed bottom-20 right-[8%] bg-[#52C95B] w-[50px] h-[50px] flex items-center justify-center rounded-full z-3 max-[1320px]:right-5">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                    ...
                    <defs>
                        <linearGradient id="paint0_linear_852_1695" x1="1062.28" y1="2117.2" x2="1062.28" y2="0.379639" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#1FAF38" />
                            <stop offset="1" stop-color="#60D669" />
                        </linearGradient>
                        <linearGradient id="paint1_linear_852_1695" x1="1100" y1="2192.73" x2="1100" y2="0" gradientUnits="userSpaceOnUse">
            ...
            {showButton ? (
                <div
                    onClick={scrollToTop}
                    className="button-gradient fixed bottom-5 right-[8%] w-[50px] h-[50px] flex items-center justify-center z-3 max-[1320px]:right-5"
                >
