...
export const Article = () => {
    ...
    const { data: articles, isPending } = useQuery({
        queryKey: ['kyrgyzstan', 'articles'],
        queryFn: kyrgyzstanApi.getArticles,
    });

    const currentArticle = articles?.results?.find((article) => article.id === id);
