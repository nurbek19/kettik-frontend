    ...
    return (
        <div>
            ...
            <div className="pt-15 pb-15 max-[1100px]:py-8">
                <h3 className="text-center pb-7 max-[1024px]:text-[36px] max-[744px]:text-[28px]">{DICTIONARY[lang].slider_title}</h3>
            ...
            <div className="relative max-w-screen-xl mx-auto pt-15 pb-[120px] max-[1100px]:py-8">
                <h3 className="text-center pb-10  max-[1024px]:text-[36px] max-[744px]:text-[28px]">{DICTIONARY[lang].reviews}</h3>
